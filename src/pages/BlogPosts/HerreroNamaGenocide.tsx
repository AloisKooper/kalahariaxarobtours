  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:image" content="/Home Images/nama genocide.png" />
        ...
        <meta name="twitter:image" content="/Home Images/nama genocide.png" />
      ...
      <PageHero
        ...
        backgroundImage="/Home Images/nama genocide.png"
        isMobile={isMobile}
      />
