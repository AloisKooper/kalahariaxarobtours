...
const PageHero: React.FC<PageHeroProps> = ({ 
  ...
  return (
    <>
      {/* Hero Section with scoped background (prevents bleed into footer) */}
      <section className="relative min-h-[40vh] md:min-h-[50vh] w-full flex items-center py-8 px-3 sm:px-4 md:px-6 hero-section overflow-hidden">
        {/* Background is now scoped to this section */}
