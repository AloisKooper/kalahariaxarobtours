  ...
  const tours = {
    cruise: [
      ...
      },
      {
        ...
        image: "/Home Images/Elderly Tour 3.jpg",
        price: "N$1800",
        addonPrice: "N$500",
        duration: "Half Day",
        minParticipants: 20,
        ...
        description: "A relaxed, scenic sightseeing experience specially designed for elderly cruise passengers. Enjoy a comfortable drive past Walvis Bay Lagoon, a slow cruise through Swakopmund's historical buildings, a visit to the craft market, and a buffet lunch with a cultural performance (soft drink, grape juice or Appletizer included) — all before returning to port.",
        dates: getNextMonthsFormatted(),
        featured: false,
        subtitle: "Also available as an add-on to any existing tour for N$500",
        routeDetails: "Pickup at Walvis Bay Harbor - Walvis Bay Lagoon - Depart to Swakopmund - Slow drive past historical buildings - Craft market - Buffet lunch & cultural performance (soft drink, grape juice or Appletizer included) - Departure back to port",
        includedItems: ["Guide", "Transportation", "Buffet lunch", "Soft drink / Grape juice / Appletizer", "Cultural performance"],
        meetingPoint: "Walvis Bay Harbor",
        pickupIncluded: true,
      }
    ],
