      ...
      <div className="container mx-auto">
        <div className="flex flex-col items-center mb-12">
          ...
          <p className="text-kalahari-charcoal/80 text-center max-w-2xl">
            For inquiries about our city or township tour experience or to book a reservation, 
        ...
        <div className="mt-16 max-w-full">
          ...
          <p className="text-kalahari-charcoal text-center max-w-2xl mx-auto mb-4">
            Explore the fascinating locations you'll visit on our city or township tour, from Walvis Bay Harbor to Swakopmund and back.
          </p>
